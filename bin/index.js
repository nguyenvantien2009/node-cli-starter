...
var gauge = grid.set(8, 10, 2, 2, contrib.gauge, {label: 'Bots', percent: [80,20]})
...
var map = grid.set(6, 0, 6, 6, contrib.map, {label: 'Visitors Location'})
...
function updateDonut(){
  ...
  donut.setData([
    {percent: parseFloat((pct+0.00) % 1).toFixed(2), label: 'Bots', 'color': color}
  ]);
  pct += 0.01;
}
